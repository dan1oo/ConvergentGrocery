...
const TripReport = () => {
  const { score=0.0 } = useRoute().params ?? {};
  ...
  return (
    <View style={styles.tripReport}>
      ...
      <View style={styles.sustainable}>
        ...
        {score>60 ? <View style={[styles.sustainable1, styles.sustainable1ShadowBox]}>
          <Text style={styles.sustainable2}>Sustainable!</Text>
        </View> : <View style={[styles.sustainable3, styles.sustainable1ShadowBox]}>
          <Text style={styles.sustainable4}>Not Sustainable!</Text>
        </View>}
